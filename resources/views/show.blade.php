...
@section('content')
    ...
    <div x-data="{ isOpen: false }">
        <div class="movie-info border-b border-gray-700">
            <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
                <img src="{{ 'https://image.tmdb.org/t/p/w500/' . $movie['poster_path'] }}" alt="poster"
                    class="w-96 mx-auto md:mx-0 md: mb-4">
        ...
        <div class="fixed top-0 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto"
            style="background-color: rgba(0,0,0,0.5);" x-show="isOpen" x-transition.opacity>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-16 mx-auto md:mx-0">
            @foreach ($movie['credits']['cast'] as $cast)
                @if ($loop->index < 5)
                    <div class="mt-8">
                        <a href="#">
                            <img src="{{ 'https://image.tmdb.org/t/p/w500/' . $cast['profile_path'] }}" alt="movie actor"
                                class="w-64 h-96 object-cover hover:opacity-75 transition-ease-in-out duration-500">
                        </a>
    ...
    <div class="movie-images container mx-auto px-4 py-16 flex" x-data="{ isOpen: false, image: '' }">
